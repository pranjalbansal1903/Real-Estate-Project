...
//[] means if there is a file then call this function
...
<input onChange ={(e)=> setFile(e.target.files[0])} type = "file" ref ={fileRef} hidden accept='image/*' />
    ...
    :(
       ...
       <input id = 'username' type ="text" placeholder ='username' defaultValue={currentUser.username} className='border p-3 rounded-lg' onChange = {handleChange} />
       
       <input id = 'email' type ="email" placeholder ='email' defaultValue={currentUser.email} className='border p-3 rounded-lg'  onChange = {handleChange} />
    ...
    Delete account</span>
       ...
       <p className='text-green-400 mt-5'>{updateSuccess ? 'user is updated successfully' : ''}
