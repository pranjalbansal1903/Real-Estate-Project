        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            <div className='flex items-center gap-2'>
              <input type="number" id='bedrooms' min='1' max='10' required className='p-3 border border-gray-300' />
              <p>Beds</p>
            </div>

            <div className='flex items-center gap-2'>
              <input type="number" id='bathrooms' min='1' max='10' required className='p-3 border border-gray-300' />
              <p>Baths</p>
            </div>

            <div className='flex items-center gap-2'>
              <input type="number" id='regular-price' min='1' max='10' required className='p-3 border border-gray-300' />
            ...
            <div className='flex items-center gap-2'>
              <input type="number" id='discount-price' min='1' max='10' required className='p-3 border border-gray-300' />
              <div className='flex flex-col items-center'>
...
<div key={url} className='flex justify-between p-3 border items-center'>
    ...
    <button type='button' onClick = {() => handleRemoveImage(index)}
     className='p-3 text-red-700 rounded-lg uppercase hover:opacity-75'> Delete </button>
          ...
          <button className='bg-slate-700 text-white hover:opacity-95 disabled:opacity-80 text-xl p-3 rounded-lg'>
            Create a Listing
          </button>
        </div>
      </form>
